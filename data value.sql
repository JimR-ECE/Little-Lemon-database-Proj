-- Start transaction for bulk insert operations
START TRANSACTION;

-- Temporarily disable foreign key checks for faster insert operations
SET foreign_key_checks = 0;

-- Insert data into CustomerDetails table
INSERT INTO `LittleLemonDB`.`CustomerDetails` (`CustomerID`, `Names`, `Contacts`) VALUES
...
INSERT INTO `LittleLemonDB`.`Staff_Information` (`StaffID`, `Name`, `Role`, `Salary`) VALUES
...
-- Insert data into OrderDeliveryStatuses table
